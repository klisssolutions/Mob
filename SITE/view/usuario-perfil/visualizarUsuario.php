                ...
                <section class="edit-usuario">
                    ...
                    <div class="info-perfil">
                        ...
                        <div class="dados-perfil">
                            <div class="dados">
                                <h1>Email:</h1>
                                <p><?php echo utf8_encode($clientes->getEmail());?></p>
                            </div>
                            <div class="dados">
                                <h1>Data de Nasc:</h1>
                                <p><?php echo utf8_encode($clientes->getDtNasc());?></p>
                            </div>
                        </div>
                        <div class="dados-perfil">
                            <div class="dados">
                        ...
                        <div class="dados-perfil">
                            <div class="dados">
                                <a href="edicaoUsuario.php?id=<?php echo utf8_encode($cliente->getIdCliente());?>">
